...
CHECKPOINT = (
    "checkpoints/bicubic_multiscale_hf/best_model.pth"
)

RESULT_DIR = (
    "results/bicubic_multiscale_hf"
)
...
print("=" * 70)
print("BICUBIC RESIDUAL + MULTI-SCALE + HF EVALUATION")
print("=" * 70)
...
print("=" * 70)
print(
    "BICUBIC RESIDUAL + MULTI-SCALE + HF RESULTS"
)
print("=" * 70)
